...
import { antiFraudServiceDefinitionsGetAntiFraudServiceDefinition } from "@gr4vy/sdk/funcs/antiFraudServiceDefinitionsGetAntiFraudServiceDefinition.js";
...
async function run() {
  const res = await antiFraudServiceDefinitionsGetAntiFraudServiceDefinition(gr4vy, "sif-ati-fraud");
