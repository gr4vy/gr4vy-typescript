...
async function run() {
  const result = await sdk.giftCards.listBuyerGiftCards("8724fd24-5489-4a5d-90fd-0604df7d3b83", "user-12345");
...
async function run() {
  const result = await sdk.giftCards.listGiftCards("8724fd24-5489-4a5d-90fd-0604df7d3b83", "user-12345", 1, "ZXhhbXBsZTE");
...
async function run() {
  const result = await sdk.giftCards.getGiftCard("e6cdf979-87e2-4796-8ff6-9784d5aed893");
...
async function run() {
  await sdk.giftCards.deleteGiftCard("e6cdf979-87e2-4796-8ff6-9784d5aed893");
