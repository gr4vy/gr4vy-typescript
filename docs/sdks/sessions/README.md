...
<!-- UsageSnippet language="typescript" operationID="create_paze_mobile_session" method="post" path="/digital-wallets/paze/session/create" -->
```typescript
import { Gr4vy } from "@gr4vy/sdk";
import fs from "fs";
...
```typescript
import { Gr4vyCore } from "@gr4vy/sdk/core.js";
import { digitalWalletsSessionsPazeMobileSessionCreate } from "@gr4vy/sdk/funcs/digitalWalletsSessionsPazeMobileSessionCreate.js";
...
async function run() {
  const res = await digitalWalletsSessionsPazeMobileSessionCreate(gr4vy, {
    client: {
      id: "0UVAS9Y03YNJ39XXYIN313F4DZNCjIGmqs4Iw32EPnZV0800o",
    },
    sessionId: "24e4dbb9-4f5e-43e8-8375-e9fd45650bc9",
  ...
  if (res.ok) {
    ...
    console.log("digitalWalletsSessionsPazeMobileSessionCreate failed:", res.error);
  }
}
...
**Promise\<[components.PazeMobileSessionCreate](../../models/components/pazemobilesessioncreate.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="create_paze_digital_wallet_session" method="post" path="/digital-wallets/paze/session" -->
```typescript
import { Gr4vy } from "@gr4vy/sdk";
import fs from "fs";
...
```typescript
import { Gr4vyCore } from "@gr4vy/sdk/core.js";
import { digitalWalletsSessionsPaze } from "@gr4vy/sdk/funcs/digitalWalletsSessionsPaze.js";
...
async function run() {
  const res = await digitalWalletsSessionsPaze(gr4vy, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("digitalWalletsSessionsPaze failed:", res.error);
  }
}
...
**Promise\<[operations.CreatePazeDigitalWalletSessionResponseCreatePazeDigitalWalletSession](../../models/operations/createpazedigitalwalletsessionresponsecreatepazedigitalwalletsession.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="review_paze_mobile_session" method="post" path="/digital-wallets/paze/session/review" -->
```typescript
import { Gr4vy } from "@gr4vy/sdk";
import fs from "fs";
...
```typescript
import { Gr4vyCore } from "@gr4vy/sdk/core.js";
import { digitalWalletsSessionsPazeMobileSessionReview } from "@gr4vy/sdk/funcs/digitalWalletsSessionsPazeMobileSessionReview.js";
...
async function run() {
  const res = await digitalWalletsSessionsPazeMobileSessionReview(gr4vy, {
    sessionId: "7c1cba03-d20e-4a3f-9d77-e5dc23a39ac2",
    code: "eyJhdWQiOm51bGwsImtpZCI6IjE3...",
    accessToken: "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9...",
  });
  if (res.ok) {
    ...
    console.log("digitalWalletsSessionsPazeMobileSessionReview failed:", res.error);
  }
}
...
**Promise\<[components.PazeSessionReview](../../models/components/pazesessionreview.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="complete_paze_mobile_session" method="post" path="/digital-wallets/paze/session/complete" -->
```typescript
import { Gr4vy } from "@gr4vy/sdk";
import fs from "fs";
...
```typescript
import { Gr4vyCore } from "@gr4vy/sdk/core.js";
import { digitalWalletsSessionsPazeMobileSessionComplete } from "@gr4vy/sdk/funcs/digitalWalletsSessionsPazeMobileSessionComplete.js";
...
async function run() {
  const res = await digitalWalletsSessionsPazeMobileSessionComplete(gr4vy, {
    sessionId: "7c1cba03-d20e-4a3f-9d77-e5dc23a39ac2",
    code: "eyJhdWQiOm51bGwsImtpZCI6IjE3...",
    accessToken: "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9...",
    transactionType: "PURCHASE",
  ...
  if (res.ok) {
    ...
    console.log("digitalWalletsSessionsPazeMobileSessionComplete failed:", res.error);
  }
}
...
**Promise\<[components.PazeSessionComplete](../../models/components/pazesessioncomplete.md)\>**
