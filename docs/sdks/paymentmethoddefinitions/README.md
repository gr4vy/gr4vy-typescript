...
import { paymentMethodDefinitionsListPaymentMethodDefinitions } from "@gr4vy/sdk/funcs/paymentMethodDefinitionsListPaymentMethodDefinitions.js";
...
async function run() {
  const res = await paymentMethodDefinitionsListPaymentMethodDefinitions(gr4vy);
