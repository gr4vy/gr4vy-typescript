...
async function run() {
  const result = await sdk.giftCardServices.getGiftCardService("541b126f-44c5-4c5e-a06b-d0e0d54c7d3f");
...
async function run() {
  const result = await sdk.giftCardServices.updateGiftCardService("541b126f-44c5-4c5e-a06b-d0e0d54c7d3f", {
    displayName: "Qwikcilver UK",
    fields: [
      {
        key: "private_key",
...
async function run() {
  await sdk.giftCardServices.deleteGiftCardService("541b126f-44c5-4c5e-a06b-d0e0d54c7d3f");
...
async function run() {
  await sdk.giftCardServices.verifyGiftCardService({
    giftCardServiceDefinitionId: "qwikcilver-gift-card",
