...
import { transactionsRefundSettlementsGet } from "@gr4vy/sdk/funcs/transactionsRefundSettlementsGet.js";
...
async function run() {
  const res = await transactionsRefundSettlementsGet(gr4vy, "7099948d-7286-47e4-aad8-b68f7eb44591", "b1e2c3d4-5678-1234-9abc-1234567890ab");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("transactionsRefundSettlementsGet failed:", res.error);
  }
}
...
**Promise\<[components.RefundSettlement](../../models/components/refundsettlement.md)\>**
...
```typescript
import { Gr4vyCore } from "@gr4vy/sdk/core.js";
import { transactionsRefundSettlementsList } from "@gr4vy/sdk/funcs/transactionsRefundSettlementsList.js";
...
async function run() {
  const res = await transactionsRefundSettlementsList(gr4vy, "7099948d-7286-47e4-aad8-b68f7eb44591");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("transactionsRefundSettlementsList failed:", res.error);
  }
}
...
**Promise\<[components.RefundSettlements](../../models/components/refundsettlements.md)\>**
