...
import { cardSchemeDefinitionsListCardSchemeDefinitions } from "@gr4vy/sdk/funcs/cardSchemeDefinitionsListCardSchemeDefinitions.js";
...
async function run() {
  const res = await cardSchemeDefinitionsListCardSchemeDefinitions(gr4vy);
