...
import { connectionDefinitionsListConnectionDefinitions } from "@gr4vy/sdk/funcs/connectionDefinitionsListConnectionDefinitions.js";
...
async function run() {
  const res = await connectionDefinitionsListConnectionDefinitions(gr4vy);
