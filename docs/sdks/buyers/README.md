...
async function run() {
  const result = await sdk.buyers.listBuyers("John", "user-12345", 1, "ZXhhbXBsZTE");
...
async function run() {
  const result = await sdk.buyers.getBuyer("8724fd24-5489-4a5d-90fd-0604df7d3b83");
...
async function run() {
  const result = await sdk.buyers.updateBuyer("8724fd24-5489-4a5d-90fd-0604df7d3b83", {
...
async function run() {
  await sdk.buyers.deleteBuyer("8724fd24-5489-4a5d-90fd-0604df7d3b83");
...
async function run() {
  const result = await sdk.buyers.listBuyerShippingDetails("8724fd24-5489-4a5d-90fd-0604df7d3b83");
...
async function run() {
  const result = await sdk.buyers.newBuyerShippingDetail("8724fd24-5489-4a5d-90fd-0604df7d3b83", {
    firstName: "John",
    lastName: "Lunn",
    emailAddress: "john@example.com",
    phoneNumber: "+1234567890",
...
async function run() {
  const result = await sdk.buyers.updateBuyerShippingDetail("8724fd24-5489-4a5d-90fd-0604df7d3b83", "8724fd24-5489-4a5d-90fd-0604df7d3b83", {
    firstName: "John",
    lastName: "Lunn",
    emailAddress: "john@example.com",
    phoneNumber: "+1234567890",
...
async function run() {
  await sdk.buyers.deleteBuyerShippingDetail("8724fd24-5489-4a5d-90fd-0604df7d3b83", "8724fd24-5489-4a5d-90fd-0604df7d3b83");
...
async function run() {
  const result = await sdk.buyers.getBuyerBillingDetails("8724fd24-5489-4a5d-90fd-0604df7d3b83", "user-12345");
...
async function run() {
  const result = await sdk.buyers.updateBuyerBillingDetails("8724fd24-5489-4a5d-90fd-0604df7d3b83", "user-12345", {
    firstName: "John",
    lastName: "Lunn",
    emailAddress: "john@example.com",
    phoneNumber: "+1234567890",
