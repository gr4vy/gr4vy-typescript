...
```typescript
import { PaymentServiceUpdateMerchantProfileMastercardMerchantProfileSingleScheme } from "@gr4vy/sdk/models/components";

let value: PaymentServiceUpdateMerchantProfileMastercardMerchantProfileSingleScheme = {};
```
