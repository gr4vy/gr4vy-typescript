...
```typescript
import { TransactionAuthorizationIncrement } from "@gr4vy/sdk/models/components";

let value: TransactionAuthorizationIncrement = {
  status: "failed",
  code: "service_error",
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `type`                                                                                                                                                      | *"transaction-authorization-increment"*                                                                                                                     | :heavy_minus_sign:                                                                                                                                          | Always `transaction-authorization-increment`.                                                                                                               | transaction-authorization-increment                                                                                                                         |
| `status`                                                                                                                                                    | [components.IncrementalAuthorizationStatus](../../models/components/incrementalauthorizationstatus.md)                                                      | :heavy_check_mark:                                                                                                                                          | N/A                                                                                                                                                         |                                                                                                                                                             |
