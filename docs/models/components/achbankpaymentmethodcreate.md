...
| `accountType`                                                                      | [components.AccountType](../../models/components/accounttype.md)                   | :heavy_minus_sign:                                                                 | Specify whether this is a `checking` or `savings` account. Defaults to `checking`. | checking                                                                           |