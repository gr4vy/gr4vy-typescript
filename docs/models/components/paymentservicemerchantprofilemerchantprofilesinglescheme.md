...
```typescript
import { PaymentServiceMerchantProfileMerchantProfileSingleScheme } from "@gr4vy/sdk/models/components";

let value: PaymentServiceMerchantProfileMerchantProfileSingleScheme = {
