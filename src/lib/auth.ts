...
export enum JWTScope {
  ...
  ApiKeyPairsRead = "api-key-pairs.read",
  ApiKeyPairsWrite = "api-key-pairs.write",
  ...
  BinCheckerRead = "bin-checker.read",
  BinCheckerWrite = "bin-checker.write",
  ...
  ThreeDSScenariosRead = "three-ds-scenarios.read",
  ThreeDSScenariosWrite = "three-ds-scenarios.write",
