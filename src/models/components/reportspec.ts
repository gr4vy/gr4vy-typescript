...
export namespace Model$ {
    export const inboundSchema = z.nativeEnum(Model);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace ReportSpecFields$ {
    export const inboundSchema = z.nativeEnum(ReportSpecFields);
    export const outboundSchema = inboundSchema;
}
...
export namespace Params$ {
    export const inboundSchema: z.ZodType<Params, z.ZodTypeDef, unknown> = collectExtraKeys$(
        z
            .object({
...
export namespace ReportSpec$ {
    export const inboundSchema: z.ZodType<ReportSpec, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ReportSpec> = z.object({
