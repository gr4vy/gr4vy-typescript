...
export namespace MerchantAccountCreateLoonAcceptedSchemes$ {
    export const inboundSchema = z.nativeEnum(MerchantAccountCreateLoonAcceptedSchemes);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace MerchantAccountCreate$ {
    export const inboundSchema: z.ZodType<MerchantAccountCreate, z.ZodTypeDef, unknown> = z
        .object({
