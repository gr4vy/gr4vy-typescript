...
export namespace FlowRuleUpdateRequestConditions$ {
    export const inboundSchema: z.ZodType<FlowRuleUpdateRequestConditions, z.ZodTypeDef, unknown> =
        z.union([
...
export namespace FlowRuleUpdateRequestOutcome$ {
    export const inboundSchema: z.ZodType<FlowRuleUpdateRequestOutcome, z.ZodTypeDef, unknown> =
        z.union([
...
export namespace FlowRuleUpdateRequest$ {
    export const inboundSchema: z.ZodType<FlowRuleUpdateRequest, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, FlowRuleUpdateRequest> =
        z.object({
            description: z.string().optional(),
            conditions: z
                .array(
