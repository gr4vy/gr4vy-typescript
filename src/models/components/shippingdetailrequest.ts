...
export namespace ShippingDetailRequestAddress$ {
    ...
    export const inboundSchema: z.ZodType<ShippingDetailRequestAddress, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ShippingDetailRequestAddress> = z
        .object({
            city: z.nullable(z.string()).optional(),
            country: z.nullable(z.string()).optional(),
...
export namespace ShippingDetailRequest$ {
    export type Inbound = {
        ...
        address?: ShippingDetailRequestAddress$.Inbound | null | undefined;
    };

    export const inboundSchema: z.ZodType<ShippingDetailRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            address: z
                .nullable(z.lazy(() => ShippingDetailRequestAddress$.inboundSchema))
                .optional(),
        })
        .transform((v) => {
            return {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ShippingDetailRequest> = z
        .object({
            ...
            address: z
                .nullable(z.lazy(() => ShippingDetailRequestAddress$.outboundSchema))
                .optional(),
        })
        .transform((v) => {
            return {
