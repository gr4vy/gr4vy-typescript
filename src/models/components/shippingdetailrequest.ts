...
export namespace ShippingDetailRequestAddress$ {
    export const inboundSchema: z.ZodType<ShippingDetailRequestAddress, z.ZodTypeDef, unknown> = z
        .object({
...
export namespace ShippingDetailRequest$ {
    export const inboundSchema: z.ZodType<ShippingDetailRequest, z.ZodTypeDef, unknown> = z
        .object({
