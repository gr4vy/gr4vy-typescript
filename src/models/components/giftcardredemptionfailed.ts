...
/** @internal */
export const GiftCardRedemptionFailedType$: z.ZodNativeEnum<typeof GiftCardRedemptionFailedType> =
    z.nativeEnum(GiftCardRedemptionFailedType);

/** @internal */
export const GiftCardRedemptionFailedName$: z.ZodNativeEnum<typeof GiftCardRedemptionFailedName> =
...
export namespace GiftCardRedemptionFailedContext$ {
    ...
    export const inboundSchema: z.ZodType<GiftCardRedemptionFailedContext, z.ZodTypeDef, Inbound> =
        z
            .object({
...
export namespace GiftCardRedemptionFailed$ {
    export type Inbound = {
        ...
        context?: GiftCardRedemptionFailedContext$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<GiftCardRedemptionFailed, z.ZodTypeDef, Inbound> = z
        .object({
            type: GiftCardRedemptionFailedType$.optional(),
            id: z.string().optional(),
            name: GiftCardRedemptionFailedName$.optional(),
            created_at: z
                .string()
