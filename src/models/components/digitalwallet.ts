...
export namespace DigitalWalletType$ {
    export const inboundSchema = z.nativeEnum(DigitalWalletType);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace DigitalWalletProvider$ {
    export const inboundSchema = z.nativeEnum(DigitalWalletProvider);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace DigitalWallet$ {
    export const inboundSchema: z.ZodType<DigitalWallet, z.ZodTypeDef, unknown> = z
        .object({
