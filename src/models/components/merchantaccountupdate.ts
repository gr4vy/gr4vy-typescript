...
export namespace MerchantAccountUpdateLoonAcceptedSchemes$ {
    export const inboundSchema = z.nativeEnum(MerchantAccountUpdateLoonAcceptedSchemes);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace MerchantAccountUpdate$ {
    export const inboundSchema: z.ZodType<MerchantAccountUpdate, z.ZodTypeDef, unknown> = z
        .object({
