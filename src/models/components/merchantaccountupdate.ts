...
export enum MerchantAccountUpdateLoonAcceptedSchemes {
    Accel = "accel",
    Amex = "amex",
...
/** @internal */
export const MerchantAccountUpdateLoonAcceptedSchemes$: z.ZodNativeEnum<
...
export namespace MerchantAccountUpdate$ {
    export type Inbound = {
        ...
        loon_accepted_schemes?: Array<MerchantAccountUpdateLoonAcceptedSchemes> | null | undefined;
    };

    export const inboundSchema: z.ZodType<MerchantAccountUpdate, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            loon_accepted_schemes: z
                .nullable(z.array(MerchantAccountUpdateLoonAcceptedSchemes$))
                .optional(),
        })
        .transform((v) => {
            return {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, MerchantAccountUpdate> = z
        .object({
