...
export namespace Items$ {
    export const inboundSchema: z.ZodType<Items, z.ZodTypeDef, unknown> = z.union([
...
export namespace TransactionHistoryEvents$ {
    export const inboundSchema: z.ZodType<TransactionHistoryEvents, z.ZodTypeDef, unknown> = z
        .object({
            items: z
                .array(
                    z.union([
