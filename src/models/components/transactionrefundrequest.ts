...
export namespace TransactionRefundRequestTargetType$ {
    export const inboundSchema = z.nativeEnum(TransactionRefundRequestTargetType);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace TransactionRefundRequest$ {
    export const inboundSchema: z.ZodType<TransactionRefundRequest, z.ZodTypeDef, unknown> = z
        .object({
            amount: z.number().int().optional(),
            target_type: z.nullable(
                TransactionRefundRequestTargetType$.inboundSchema.default(
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, TransactionRefundRequest> = z
        .object({
            ...
            targetType: z.nullable(
                TransactionRefundRequestTargetType$.outboundSchema.default(
                    TransactionRefundRequestTargetType.PaymentMethod
                )
            ),
