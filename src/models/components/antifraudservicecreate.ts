...
export namespace AntiFraudServiceDefinitionId$ {
    export const inboundSchema = z.nativeEnum(AntiFraudServiceDefinitionId);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace AntiFraudServiceCreateFields$ {
    export const inboundSchema: z.ZodType<AntiFraudServiceCreateFields, z.ZodTypeDef, unknown> =
        z.object({
            key: z.string(),
            value: z.string(),
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AntiFraudServiceCreateFields> =
        z.object({
            key: z.string(),
            value: z.string(),
        });
...
export namespace AntiFraudServiceCreate$ {
    export const inboundSchema: z.ZodType<AntiFraudServiceCreate, z.ZodTypeDef, unknown> = z
        .object({
