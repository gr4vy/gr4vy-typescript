...
/** @internal */
export const PazePaymentMethodCreate$outboundSchema: z.ZodType<
...
export function pazePaymentMethodCreateToJSON(
  pazePaymentMethodCreate: PazePaymentMethodCreate,
): string {
  return JSON.stringify(
    PazePaymentMethodCreate$outboundSchema.parse(pazePaymentMethodCreate),
  );
}
