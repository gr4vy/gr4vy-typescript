...
/** @internal */
export const TransactionType$: z.ZodNativeEnum<typeof TransactionType> =
    z.nativeEnum(TransactionType);

/** @internal */
export const AvsResponseCode$: z.ZodNativeEnum<typeof AvsResponseCode> =
    z.nativeEnum(AvsResponseCode);

/** @internal */
export const TransactionBuyerType$: z.ZodNativeEnum<typeof TransactionBuyerType> =
    z.nativeEnum(TransactionBuyerType);

/** @internal */
export const TransactionBuyerBillingDetailsType$: z.ZodNativeEnum<
...
export namespace TransactionBuyerAddress$ {
    ...
    export const inboundSchema: z.ZodType<TransactionBuyerAddress, z.ZodTypeDef, Inbound> = z
        .object({
...
/** @internal */
export const TransactionKind$: z.ZodNativeEnum<typeof TransactionKind> =
...
export namespace TransactionTaxID$ {
    ...
    export const inboundSchema: z.ZodType<TransactionTaxID, z.ZodTypeDef, Inbound> = z
        .object({
            value: z.string(),
            kind: TransactionKind$,
        })
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, TransactionTaxID> = z
        .object({
            value: z.string(),
            kind: TransactionKind$,
        })
...
export namespace TransactionBillingDetails$ {
    export type Inbound = {
        ...
        address?: TransactionBuyerAddress$.Inbound | null | undefined;
        tax_id?: TransactionTaxID$.Inbound | null | undefined;
    };

    export const inboundSchema: z.ZodType<TransactionBillingDetails, z.ZodTypeDef, Inbound> = z
        .object({
            type: TransactionBuyerBillingDetailsType$.optional(),
...
export namespace TransactionBuyerSnapshot$ {
    export type Inbound = {
        type?: TransactionBuyerType | undefined;
        id?: string | undefined;
        billing_details?: TransactionBillingDetails$.Inbound | null | undefined;
        display_name?: string | null | undefined;
        external_identifier?: string | null | undefined;
    };

    export const inboundSchema: z.ZodType<TransactionBuyerSnapshot, z.ZodTypeDef, Inbound> = z
        .object({
            type: TransactionBuyerType$.optional(),
...
/** @internal */
export const CvvResponseCode$: z.ZodNativeEnum<typeof CvvResponseCode> =
    z.nativeEnum(CvvResponseCode);

/** @internal */
export const TransactionInstrumentType$: z.ZodNativeEnum<typeof TransactionInstrumentType> =
    z.nativeEnum(TransactionInstrumentType);

/** @internal */
export const TransactionIntent$: z.ZodNativeEnum<typeof TransactionIntent> =
    z.nativeEnum(TransactionIntent);

/** @internal */
export const IntentOutcome$: z.ZodNativeEnum<typeof IntentOutcome> = z.nativeEnum(IntentOutcome);

/** @internal */
export const TransactionMethod$: z.ZodNativeEnum<typeof TransactionMethod> =
    z.nativeEnum(TransactionMethod);

/** @internal */
export const TransactionPaymentMethodType$: z.ZodNativeEnum<typeof TransactionPaymentMethodType> =
    z.nativeEnum(TransactionPaymentMethodType);

/** @internal */
export const TransactionApprovalTarget$: z.ZodNativeEnum<typeof TransactionApprovalTarget> =
    z.nativeEnum(TransactionApprovalTarget);

/** @internal */
export const TransactionCardType$: z.ZodNativeEnum<typeof TransactionCardType> =
    z.nativeEnum(TransactionCardType);

/** @internal */
export namespace TransactionCard$ {
    export type Inbound = {
        card_type?: TransactionCardType | undefined;
        bin?: string | undefined;
    };

    export const inboundSchema: z.ZodType<TransactionCard, z.ZodTypeDef, Inbound> = z
        .object({
            card_type: TransactionCardType$.optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, TransactionCard> = z
        .object({
            cardType: TransactionCardType$.optional(),
            bin: z.string().optional(),
        })
        .transform((v) => {
            return {
...
/** @internal */
export const TransactionPaymentMethodMethod$: z.ZodNativeEnum<
    typeof TransactionPaymentMethodMethod
> = z.nativeEnum(TransactionPaymentMethodMethod);

/** @internal */
export const TransactionScheme$: z.ZodNativeEnum<typeof TransactionScheme> =
...
export namespace TransactionPaymentMethodSnapshot$ {
    export type Inbound = {
        type?: TransactionPaymentMethodType | undefined;
        id?: string | null | undefined;
        approval_target?: TransactionApprovalTarget | null | undefined;
        approval_url?: string | null | undefined;
        country?: string | null | undefined;
        currency?: string | null | undefined;
        details?: TransactionCard$.Inbound | null | undefined;
    ...
    export const inboundSchema: z.ZodType<TransactionPaymentMethodSnapshot, z.ZodTypeDef, Inbound> =
        z
            .object({
                type: TransactionPaymentMethodType$.optional(),
                id: z.nullable(z.string()).optional(),
                approval_target: z.nullable(TransactionApprovalTarget$).optional(),
                ...
                last_replaced_at: z
                    ...
                    .optional(),
                method: TransactionPaymentMethodMethod$.optional(),
                payment_account_reference: z.nullable(z.string()).optional(),
                scheme: z.nullable(TransactionScheme$).optional(),
            ...
            .transform((v) => {
                return {
                    ...(v.type === undefined ? null : { type: v.type }),
                    ...(v.id === undefined ? null : { id: v.id }),
                    ...(v.approval_target === undefined
                        ? null
                        : { approvalTarget: v.approval_target }),
                    ...(v.approval_url === undefined ? null : { approvalUrl: v.approval_url }),
                    ...(v.country === undefined ? null : { country: v.country }),
                    ...(v.currency === undefined ? null : { currency: v.currency }),
                    ...(v.details === undefined ? null : { details: v.details }),
                    ...(v.expiration_date === undefined
                        ? null
    ...
    > = z
        .object({
            type: TransactionPaymentMethodType$.optional(),
            id: z.nullable(z.string()).optional(),
            approvalTarget: z.nullable(TransactionApprovalTarget$).optional(),
...
/** @internal */
export const TransactionPaymentServiceType$: z.ZodNativeEnum<typeof TransactionPaymentServiceType> =
    z.nativeEnum(TransactionPaymentServiceType);

/** @internal */
export const TransactionPaymentServiceMethod$: z.ZodNativeEnum<
...
export namespace TransactionAPaymentService$ {
    ...
    export const inboundSchema: z.ZodType<TransactionAPaymentService, z.ZodTypeDef, Inbound> = z
        .object({
            type: TransactionPaymentServiceType$.optional(),
            id: z.string().optional(),
            display_name: z.string().optional(),
            method: TransactionPaymentServiceMethod$.optional(),
...
/** @internal */
export const TransactionPaymentSource$: z.ZodNativeEnum<typeof TransactionPaymentSource> =
    z.nativeEnum(TransactionPaymentSource);

/** @internal */
export const TransactionShippingDetailsType$: z.ZodNativeEnum<
...
export namespace TransactionAddress$ {
    ...
    export const inboundSchema: z.ZodType<TransactionAddress, z.ZodTypeDef, Inbound> = z
        .object({
            city: z.nullable(z.string()).optional(),
            country: z.nullable(z.string()).optional(),
            postal_code: z.nullable(z.string()).optional(),
...
export namespace TransactionShippingDetail$ {
    export type Inbound = {
        ...
        email_address?: string | null | undefined;
        phone_number?: string | null | undefined;
        address?: TransactionAddress$.Inbound | null | undefined;
    };

    export const inboundSchema: z.ZodType<TransactionShippingDetail, z.ZodTypeDef, Inbound> = z
        .object({
            type: TransactionShippingDetailsType$.optional(),
            id: z.string().optional(),
...
export namespace TransactionStatementDescriptor$ {
    ...
    export const inboundSchema: z.ZodType<TransactionStatementDescriptor, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace Transaction$ {
    export type Inbound = {
        ...
        avs_response_code?: AvsResponseCode | null | undefined;
        buyer?: TransactionBuyerSnapshot$.Inbound | null | undefined;
        ...
        currency?: string | undefined;
        cvv_response_code?: CvvResponseCode | null | undefined;
        error_code?: string | null | undefined;
        external_identifier?: string | null | undefined;
        gift_card_service?: GiftCardServiceSnapshot$.Inbound | undefined;
        gift_card_redemptions?: Array<GiftCardRedemption$.Inbound> | undefined;
        instrument_type?: TransactionInstrumentType | null | undefined;
        intent?: TransactionIntent | undefined;
        intent_outcome?: IntentOutcome | undefined;
        ...
        payment_method?: TransactionPaymentMethodSnapshot$.Inbound | null | undefined;
        payment_service?: TransactionAPaymentService$.Inbound | null | undefined;
        payment_service_transaction_id?: string | undefined;
        payment_source?: TransactionPaymentSource | undefined;
        ...
        shipping_details?: TransactionShippingDetail$.Inbound | null | undefined;
        statement_descriptor?: TransactionStatementDescriptor$.Inbound | null | undefined;
        status?: TransactionStatus | undefined;
        three_d_secure?: ThreeDSecureSummary$.Inbound | undefined;
    ...
    export const inboundSchema: z.ZodType<Transaction, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            approval_expires_at: z
                ...
                .optional(),
            avs_response_code: z.nullable(AvsResponseCode$).optional(),
            ...
            cvv_response_code: z.nullable(CvvResponseCode$).optional(),
            ...
            instrument_type: z.nullable(TransactionInstrumentType$).optional(),
            intent: TransactionIntent$.optional(),
            intent_outcome: IntentOutcome$.optional(),
            ...
            method: z.nullable(TransactionMethod$).optional(),
            ...
            payment_source: TransactionPaymentSource$.optional(),
        ...
        .transform((v) => {
            return {
                ...
                ...(v.auth_response_code === undefined
                    ? null
                    : { authResponseCode: v.auth_response_code }),
                ...
                ...(v.approval_expires_at === undefined
                    ? null
                ...
                ...(v.external_identifier === undefined
                    ? null
                    : { externalIdentifier: v.external_identifier }),
                ...(v.gift_card_service === undefined
                    ? null
                    : { giftCardService: v.gift_card_service }),
                ...
                ...(v.intent_outcome === undefined ? null : { intentOutcome: v.intent_outcome }),
                ...
                ...(v.method === undefined ? null : { method: v.method }),
                ...(v.multi_tender === undefined ? null : { multiTender: v.multi_tender }),
                ...
                schemeTransactionId: v.scheme_transaction_id,
                ...(v.shipping_details === undefined
                    ? null
                    : { shippingDetails: v.shipping_details }),
                ...(v.statement_descriptor === undefined
                    ? null
                    : { statementDescriptor: v.statement_descriptor }),
                ...(v.status === undefined ? null : { status: v.status }),
                ...(v.three_d_secure === undefined ? null : { threeDSecure: v.three_d_secure }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Transaction> = z
        .object({
            ...
            avsResponseCode: z.nullable(AvsResponseCode$).optional(),
            ...
            createdAt: z
                ...
                .optional(),
            currency: z.string().optional(),
            cvvResponseCode: z.nullable(CvvResponseCode$).optional(),
            ...
            instrumentType: z.nullable(TransactionInstrumentType$).optional(),
            intent: TransactionIntent$.optional(),
            intentOutcome: IntentOutcome$.optional(),
            ...
            paymentSource: TransactionPaymentSource$.optional(),
        ...
        .transform((v) => {
            return {
                ...
                ...(v.id === undefined ? null : { id: v.id }),
                ...(v.amount === undefined ? null : { amount: v.amount }),
                ...(v.authResponseCode === undefined
                    ? null
                    : { auth_response_code: v.authResponseCode }),
                ...
                ...(v.approvalExpiresAt === undefined
                    ? null
                    : { approval_expires_at: v.approvalExpiresAt }),
                ...
                ...(v.giftCardService === undefined
                    ? null
                    : { gift_card_service: v.giftCardService }),
                ...
                ...(v.intent === undefined ? null : { intent: v.intent }),
                ...(v.intentOutcome === undefined ? null : { intent_outcome: v.intentOutcome }),
                ...
                ...(v.metadata === undefined ? null : { metadata: v.metadata }),
                ...(v.method === undefined ? null : { method: v.method }),
                ...(v.multiTender === undefined ? null : { multi_tender: v.multiTender }),
                ...
                scheme_transaction_id: v.schemeTransactionId,
                ...(v.shippingDetails === undefined
                    ? null
                    : { shipping_details: v.shippingDetails }),
                ...(v.statementDescriptor === undefined
                    ? null
                    : { statement_descriptor: v.statementDescriptor }),
                ...(v.status === undefined ? null : { status: v.status }),
                ...(v.threeDSecure === undefined ? null : { three_d_secure: v.threeDSecure }),
