...
export namespace DigitalWalletClickToPayTokenDecryptedType$ {
    export const inboundSchema = z.nativeEnum(DigitalWalletClickToPayTokenDecryptedType);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace DigitalWalletClickToPayTokenDecryptedName$ {
    export const inboundSchema = z.nativeEnum(DigitalWalletClickToPayTokenDecryptedName);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace DigitalWalletClickToPayTokenDecryptedContextType$ {
    export const inboundSchema = z.nativeEnum(DigitalWalletClickToPayTokenDecryptedContextType);
    export const outboundSchema = inboundSchema;
}
