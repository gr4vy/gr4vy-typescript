 ...
 * The kind of tax ID.
 */
export const BillingDetailsKind = {
    AeTrn: "ae.trn",
    AuAbn: "au.abn",
    ArDni: "ar.dni",
    ArCuil: "ar.cuil",
 ...
 * The kind of tax ID.
 */
export type BillingDetailsKind = ClosedEnum<typeof BillingDetailsKind>;
...
/** @internal */
export const BillingDetailsKind$inboundSchema: z.ZodNativeEnum<typeof BillingDetailsKind> =
    z.nativeEnum(BillingDetailsKind);

/** @internal */
export const BillingDetailsKind$outboundSchema: z.ZodNativeEnum<typeof BillingDetailsKind> =
    BillingDetailsKind$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace BillingDetailsKind$ {
    /** @deprecated use `BillingDetailsKind$inboundSchema` instead. */
    export const inboundSchema = BillingDetailsKind$inboundSchema;
    /** @deprecated use `BillingDetailsKind$outboundSchema` instead. */
    export const outboundSchema = BillingDetailsKind$outboundSchema;
}

/** @internal */
export const TaxID$inboundSchema: z.ZodType<TaxID, z.ZodTypeDef, unknown> = z.object({
    value: z.string(),
    kind: BillingDetailsKind$inboundSchema,
});
...
export const TaxID$outboundSchema: z.ZodType<TaxID$Outbound, z.ZodTypeDef, TaxID> = z.object({
    value: z.string(),
    kind: BillingDetailsKind$outboundSchema,
});
