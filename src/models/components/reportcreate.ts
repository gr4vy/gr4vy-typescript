...
export namespace ReportCreateModel$ {
    export const inboundSchema = z.nativeEnum(ReportCreateModel);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace ReportCreateFields$ {
    export const inboundSchema = z.nativeEnum(ReportCreateFields);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace ReportCreateFilters$ {
    export const inboundSchema: z.ZodType<ReportCreateFilters, z.ZodTypeDef, unknown> = z
        .object({
...
export namespace ReportCreateSort$ {
    export const inboundSchema: z.ZodType<ReportCreateSort, z.ZodTypeDef, unknown> = z.object({});
...
export namespace ReportCreateParams$ {
    export const inboundSchema: z.ZodType<ReportCreateParams, z.ZodTypeDef, unknown> =
        collectExtraKeys$(
            z
                .object({
...
export namespace ReportSpecification$ {
    export const inboundSchema: z.ZodType<ReportSpecification, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ReportSpecification> = z.object({
...
export namespace ReportCreate$ {
    export const inboundSchema: z.ZodType<ReportCreate, z.ZodTypeDef, unknown> = z
        .object({
            name: z.string(),
            description: z.nullable(z.string()).optional(),
            schedule: Schedule$.inboundSchema.default(Schedule.Once),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ReportCreate> = z
        .object({
            name: z.string(),
            description: z.nullable(z.string()).optional(),
            schedule: Schedule$.outboundSchema.default(Schedule.Once),
