 ...
 */
export function transactionsIncrementAuthorization(
  client: Gr4vyCore,
  ...
  Result<
    components.TransactionAuthorizationIncrement,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error404
...
> {
  const input: operations.IncrementTransactionAuthorizationRequest = {
    transactionAuthorizationIncrementCreate:
      transactionAuthorizationIncrementCreate,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.IncrementTransactionAuthorizationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.TransactionAuthorizationIncrementCreate,
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.TransactionAuthorizationIncrement$inboundSchema),
