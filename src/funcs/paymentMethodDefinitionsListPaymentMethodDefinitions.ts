 ...
 */
export async function paymentMethodDefinitionsListPaymentMethodDefinitions(
    client$: Gr4vyCore,
    options?: RequestOptions
): Promise<
    Result<
        components.PaymentMethodDefinitions,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.PaymentMethodDefinitions$inboundSchema),
