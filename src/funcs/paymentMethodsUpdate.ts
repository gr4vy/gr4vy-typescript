...
> {
  const input: operations.UpdatePaymentMethodRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.UpdatePaymentMethodRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PaymentMethodUpdate, {
    explode: true,
  });
