 ...
 */
export function merchantAccountsThreeDsConfigurationDelete(
  client: Gr4vyCore,
...
> {
  const input: operations.DeleteThreeDsConfigurationRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeleteThreeDsConfigurationRequest$outboundSchema.parse(value),
