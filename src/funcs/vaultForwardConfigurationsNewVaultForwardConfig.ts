 ...
 */
export async function vaultForwardConfigurationsNewVaultForwardConfig(
    client$: Gr4vyCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.PCIForwardConfigRequest$outboundSchema.optional().parse(value$),
    ...
    const path$ = pathToFunc("/vault-forward/configs")();
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, components.PCIForwardConfig$inboundSchema),
