 ...
 * PCI data to.
 */
export async function vaultForwardConfigurationsListVaultForwardConfig(
    client$: Gr4vyCore,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.PCIForwardConfigs$inboundSchema),
