 ...
 */
export async function connectionDefinitionsListConnectionDefinitions(
    client$: Gr4vyCore,
    options?: RequestOptions
): Promise<
    Result<
        components.ConnectionDefinitions,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.ConnectionDefinitions$inboundSchema),
