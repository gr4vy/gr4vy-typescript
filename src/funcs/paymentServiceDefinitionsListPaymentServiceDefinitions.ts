 ...
 */
export async function paymentServiceDefinitionsListPaymentServiceDefinitions(
    client$: Gr4vyCore,
    ...
    Result<
        components.PaymentServiceDefinitions,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.PaymentServiceDefinitions$inboundSchema),
