 ...
 */
export async function giftCardServiceDefinitionsGetGiftCardServiceDefinition(
    client$: Gr4vyCore,
    giftCardServiceDefinitionId: string,
    options?: RequestOptions
): Promise<
    Result<
        components.GiftCardServiceDefinition,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.GiftCardServiceDefinition$inboundSchema),
