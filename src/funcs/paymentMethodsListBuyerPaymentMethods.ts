 ...
 */
export async function paymentMethodsListBuyerPaymentMethods(
    client$: Gr4vyCore,
    ...
    Result<
        components.PaymentMethodsTokenized,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.PaymentMethodsTokenized$inboundSchema),
