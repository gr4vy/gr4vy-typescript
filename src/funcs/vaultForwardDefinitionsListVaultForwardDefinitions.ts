 ...
 * can be forwarded to.
 */
export async function vaultForwardDefinitionsListVaultForwardDefinitions(
    client$: Gr4vyCore,
    options?: RequestOptions
): Promise<
    Result<
        components.PCIForwardDefinitions,
    ...
    >
> {
    const path$ = pathToFunc("/vault-forward/definitions")();
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.PCIForwardDefinitions$inboundSchema),
