 ...
 */
export async function buyersUpdateBuyerShippingDetail(
    client$: Gr4vyCore,
    buyerId: string,
...
> {
    ...
    const path$ = pathToFunc("/buyers/{buyer_id}/shipping-details/{shipping_detail_id}")(
        pathParams$
    );
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.ShippingDetail$inboundSchema),
