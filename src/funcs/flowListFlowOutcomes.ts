 ...
 */
export async function flowListFlowOutcomes(
    client$: Gr4vyCore,
...
> {
    ...
    const path$ = pathToFunc("/flows/{flow}/actions/{action}/outcomes")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.FlowRuleOutcomes$inboundSchema),
