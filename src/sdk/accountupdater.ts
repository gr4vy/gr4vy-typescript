...
export class AccountUpdater extends ClientSDK {
    ...
    async newAccountUpdaterJob(
        input: components.AccountUpdaterJobCreate | undefined,
        options?: RequestOptions
    ): Promise<components.AccountUpdaterJob | void> {
        ...
        if (this.matchResponse(response, 201, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return components.AccountUpdaterJob$.inboundSchema.parse(val$);
                },
